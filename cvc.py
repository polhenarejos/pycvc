...
OID_ID_CA                       = OID_BSI_DE + b"\x02\x02\x03"

OID_ID_CA_DH                    = OID_ID_CA + b"\x01"

OID_ID_CA_DH_3DES_CBC_CBC       = OID_ID_CA_DH + b"\x01"
OID_ID_CA_DH_AES_CBC_CMAC_128   = OID_ID_CA_DH + b"\x02"
OID_ID_CA_DH_AES_CBC_CMAC_192   = OID_ID_CA_DH + b"\x03"
OID_ID_CA_DH_AES_CBC_CMAC_256   = OID_ID_CA_DH + b"\x04"

OID_ID_CA_ECDH                  = OID_ID_CA+ b"\x02"

OID_ID_CA_ECDH_3DES_CBC_CBC     = OID_ID_CA_ECDH + b"\x01"
OID_ID_CA_ECDH_AES_CBC_CMAC_128 = OID_ID_CA_ECDH + b"\x02"
OID_ID_CA_ECDH_AES_CBC_CMAC_192 = OID_ID_CA_ECDH + b"\x03"
OID_ID_CA_ECDH_AES_CBC_CMAC_256 = OID_ID_CA_ECDH + b"\x04"

OID_ID_PK                       = OID_BSI_DE + b"\x02\x02\0x1"
OID_ID_PK_DH                    = OID_ID_PK + b"\x01"
OID_ID_PK_ECDH                  = OID_ID_PK + b"\x02"

OID_ID_TA                       = OID_BSI_DE + b"\x02\x02\x02"

OID_ID_TA_RSA                   = OID_ID_TA + b"\x01"

OID_ID_TA_RSA_V1_5_SHA_1        = OID_ID_TA_RSA + b"\x01"
OID_ID_TA_RSA_V1_5_SHA_256      = OID_ID_TA_RSA + b"\x02"
OID_ID_TA_RSA_PSS_SHA_1         = OID_ID_TA_RSA + b"\x03"
OID_ID_TA_RSA_PSS_SHA_256       = OID_ID_TA_RSA + b"\x04"
OID_ID_TA_RSA_V1_5_SHA_512      = OID_ID_TA_RSA + b"\x05"
OID_ID_TA_RSA_PSS_SHA_512       = OID_ID_TA_RSA + b"\x06"

OID_ID_TA_ECDSA                 = OID_ID_TA + b"\x02"

OID_IT_TA_ECDSA_SHA_1           = OID_ID_TA_ECDSA + b"\x01"
OID_IT_TA_ECDSA_SHA_224         = OID_ID_TA_ECDSA + b"\x02"
OID_IT_TA_ECDSA_SHA_256         = OID_ID_TA_ECDSA + b"\x03"
OID_IT_TA_ECDSA_SHA_384         = OID_ID_TA_ECDSA + b"\x04"
OID_IT_TA_ECDSA_SHA_512         = OID_ID_TA_ECDSA + b"\x05"

OID_ID_RI                       = OID_BSI_DE + b"\x02\x02\x05"

OID_ID_RI_DH                    = OID_ID_RI + b"\x01"

OID_ID_RI_DH_SHA_1              = OID_ID_RI_DH + b"\x01"
OID_ID_RI_DH_SHA_224            = OID_ID_RI_DH + b"\x02"
OID_ID_RI_DH_SHA_256            = OID_ID_RI_DH + b"\x03"

OID_ID_RI_ECDH                  = OID_ID_RI + b"\x02" 

OID_ID_RI_ECDH_SHA_1            = OID_ID_RI_ECDH + b"\x01"
OID_ID_RI_ECDH_SHA_224          = OID_ID_RI_ECDH + b"\x02"
...
def asn1_oid(oid):
    return add_tag(0x6, oid)

def cvc_public_key_rsa(rsa):
    n = asn1_context(0x81, rsa.public_numbers().n)
    e = asn1_context(0x82, rsa.public_numbers().e)
...
def cvc_public_key_ecdsa(ecdsa):
    ...
    b = add_tag(0x83, dom.B)
    g = add_tag(0x84, dom.G)
    o = add_tag(0x85, dom.O)
